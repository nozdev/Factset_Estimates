...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TargetPrice : IEquatable<TargetPrice>
    {
        /// <summary>
        ...
        /* <example>15</example> */
        [DataMember(Name="analystsCount", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TargetPrice)obj);
        }

        /// <summary>
        /// Returns true if TargetPrice instances are equal
        /// </summary>
        /// <param name="other">Instance of TargetPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TargetPrice other)
        {
            ...
            return 
                ...
                (
                    AnalystsCount == other.AnalystsCount ||
                    
                    AnalystsCount.Equals(other.AnalystsCount)
                ) && 
                (
                    Mean == other.Mean ||
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AnalystsCount.GetHashCode();
        ...
        public static bool operator ==(TargetPrice left, TargetPrice right)
        {
