...
{ 
    ...
    /// </summary>
    [ApiController]
    public class SegmentActualsApiController : ControllerBase
    { 
        /// <summary>
        /// Retrieves Segment Actuals for a requested list of ids and reported fiscal periods.
        /// </summary>
        /// <remarks>Returns FactSet Estimates Actuals data using rolling fiscal dates for company business and geographic segments. &lt;p&gt; </remarks>
        ...
        [HttpGet]
        [Route("/content/factset-estimates/v2/segment-actuals")]
        [ValidateModelState]
        [SwaggerOperation("GetSegmentActuals")]
        [SwaggerResponse(statusCode: 200, type: typeof(SegmentActualsResponse), description: "Estimate data items")]
        ...
        public virtual IActionResult GetSegmentActuals([FromQuery (Name = "ids")][Required()]List<string> ids, [FromQuery (Name = "segmentType")][Required()]string segmentType, [FromQuery (Name = "metrics")][Required()]List<string> metrics, [FromQuery (Name = "relativeFiscalStart")]int? relativeFiscalStart, [FromQuery (Name = "relativeFiscalEnd")]int? relativeFiscalEnd, [FromQuery (Name = "periodicity")]string periodicity, [FromQuery (Name = "currency")]string currency)
        {
            ...
            exampleJson = "{\r\n  \"data\" : [ {\r\n    \"fsymId\" : \"SJY281-R\",\r\n    \"segmentLabel\" : \"Productivity and Business Processes\",\r\n    \"estimateCurrency\" : \"USD\",\r\n    \"segmentActualType\" : \"company\",\r\n    \"fiscalEndDate\" : \"2023-06-30\",\r\n    \"reportDate\" : \"2023-07-26\",\r\n    \"metric\" : \"SALES\",\r\n    \"requestId\" : \"AAPL-USA\",\r\n    \"periodicity\" : \"ANN\",\r\n    \"fiscalPeriod\" : 1,\r\n    \"currency\" : \"USD\",\r\n    \"segmentActualValue\" : 69274,\r\n    \"fiscalYear\" : 2023,\r\n    \"segmentLevel\" : \"S\",\r\n    \"segmentType\" : \"Productivity and Business Processes\"\r\n  }, {\r\n    \"fsymId\" : \"SJY281-R\",\r\n    \"segmentLabel\" : \"Productivity and Business Processes\",\r\n    \"estimateCurrency\" : \"USD\",\r\n    \"segmentActualType\" : \"company\",\r\n    \"fiscalEndDate\" : \"2023-06-30\",\r\n    \"reportDate\" : \"2023-07-26\",\r\n    \"metric\" : \"SALES\",\r\n    \"requestId\" : \"AAPL-USA\",\r\n    \"periodicity\" : \"ANN\",\r\n    \"fiscalPeriod\" : 1,\r\n    \"currency\" : \"USD\",\r\n    \"segmentActualValue\" : 69274,\r\n    \"fiscalYear\" : 2023,\r\n    \"segmentLevel\" : \"S\",\r\n    \"segmentType\" : \"Productivity and Business Processes\"\r\n  } ]\r\n}";
            ...
            ? JsonConvert.DeserializeObject<SegmentActualsResponse>(exampleJson)
            : default;
        ...
        [ValidateModelState]
        [SwaggerOperation("GetSegmentActualsForList")]
        [SwaggerResponse(statusCode: 200, type: typeof(SegmentActualsResponse), description: "List of Estimate metric Ids")]
        [SwaggerResponse(statusCode: 400, type: typeof(ErrorResponse), description: "Bad Request. This can occur for several reasons. Please review the \"message\" for more details.")]
        [SwaggerResponse(statusCode: 401, type: typeof(ErrorResponse), description: "Unauthenticated USERNAME-SERIAL. Ensure you are logged in and have successfully generated an API KEY for the IP range you are connecting from. For more help, select the **Report Issue** in the top right corner of this Developer Portal specification card and choose Connectivity 401 or 403 Responses.")]
        [SwaggerResponse(statusCode: 403, type: typeof(ErrorResponse), description: "The USERNAME-SERIAL attempted to request the endpoint is not authorized to access. The request was a legal request, but the server is refusing to respond. Please reach out to FactSet Account Team for assistance with authorization.")]
        [SwaggerResponse(statusCode: 415, type: typeof(ErrorResponse), description: "Unsupported Media Type. This error may be returned when the caller sends a resource in a format that is not accepted by the server. This can be fixed by ensuring that Content-Type header is set to the correct value. In this instance, \"application/json\" would be the appropriate value.")]
        [SwaggerResponse(statusCode: 500, type: typeof(ErrorResponse), description: "Internal Server Error.")]
        public virtual IActionResult GetSegmentActualsForList([FromBody]SegmentActualsRequest segmentActualsRequest)
        {
