...
namespace FactsetEstimatesClient.Client
{
    ...
    public class BasicToken : TokenBase
    {
        ...
        {
            request.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Basic", FactsetEstimatesClient.Client.ClientUtils.Base64Encode(_username + ":" + _password));
        }
    }
}