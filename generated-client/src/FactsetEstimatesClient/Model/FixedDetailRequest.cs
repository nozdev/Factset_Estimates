...
namespace FactsetEstimatesClient.Model
{
    ...
    /// </summary>
    public partial class FixedDetailRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public FixedDetailRequest(List<string> ids, List<string> metrics, Option<DateOnly?> startDate = default, Option<DateOnly?> endDate = default, Option<Frequency?> frequency = default, Option<bool?> includeAll = default, Option<PeriodicityDetail?> periodicity = default, Option<string?> fiscalPeriodStart = default, Option<string?> fiscalPeriodEnd = default, Option<string?> currency = default)
        {
            Ids = ids;
            Metrics = metrics;
    ...
    /// <summary>
    /// A Json converter for type <see cref="FixedDetailRequest" />
    /// </summary>
    public class FixedDetailRequestJsonConverter : JsonConverter<FixedDetailRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="FixedDetailRequest" />
        /// </summary>
        ...
        public override FixedDetailRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!ids.IsSet)
                throw new ArgumentException("Property is required for class FixedDetailRequest.", nameof(ids));

            if (!metrics.IsSet)
                throw new ArgumentException("Property is required for class FixedDetailRequest.", nameof(metrics));

            if (ids.IsSet && ids.Value == null)
                throw new ArgumentNullException(nameof(ids), "Property is not nullable for class FixedDetailRequest.");

            if (metrics.IsSet && metrics.Value == null)
                throw new ArgumentNullException(nameof(metrics), "Property is not nullable for class FixedDetailRequest.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class FixedDetailRequest.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class FixedDetailRequest.");

            if (frequency.IsSet && frequency.Value == null)
                throw new ArgumentNullException(nameof(frequency), "Property is not nullable for class FixedDetailRequest.");

            if (includeAll.IsSet && includeAll.Value == null)
                throw new ArgumentNullException(nameof(includeAll), "Property is not nullable for class FixedDetailRequest.");

            if (periodicity.IsSet && periodicity.Value == null)
                throw new ArgumentNullException(nameof(periodicity), "Property is not nullable for class FixedDetailRequest.");

            if (fiscalPeriodStart.IsSet && fiscalPeriodStart.Value == null)
                throw new ArgumentNullException(nameof(fiscalPeriodStart), "Property is not nullable for class FixedDetailRequest.");

            if (fiscalPeriodEnd.IsSet && fiscalPeriodEnd.Value == null)
                throw new ArgumentNullException(nameof(fiscalPeriodEnd), "Property is not nullable for class FixedDetailRequest.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class FixedDetailRequest.");

            return new FixedDetailRequest(ids.Value!, metrics.Value!, startDate, endDate, frequency, includeAll, periodicity, fiscalPeriodStart, fiscalPeriodEnd, currency);
        }

        /// <summary>
        /// Serializes a <see cref="FixedDetailRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fixedDetailRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, FixedDetailRequest fixedDetailRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, fixedDetailRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="FixedDetailRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="fixedDetailRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, FixedDetailRequest fixedDetailRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (fixedDetailRequest.Ids == null)
                throw new ArgumentNullException(nameof(fixedDetailRequest.Ids), "Property is required for class FixedDetailRequest.");

            if (fixedDetailRequest.Metrics == null)
                throw new ArgumentNullException(nameof(fixedDetailRequest.Metrics), "Property is required for class FixedDetailRequest.");

            if (fixedDetailRequest.FiscalPeriodStartOption.IsSet && fixedDetailRequest.FiscalPeriodStart == null)
                throw new ArgumentNullException(nameof(fixedDetailRequest.FiscalPeriodStart), "Property is required for class FixedDetailRequest.");

            if (fixedDetailRequest.FiscalPeriodEndOption.IsSet && fixedDetailRequest.FiscalPeriodEnd == null)
                throw new ArgumentNullException(nameof(fixedDetailRequest.FiscalPeriodEnd), "Property is required for class FixedDetailRequest.");

            if (fixedDetailRequest.CurrencyOption.IsSet && fixedDetailRequest.Currency == null)
                throw new ArgumentNullException(nameof(fixedDetailRequest.Currency), "Property is required for class FixedDetailRequest.");

            writer.WritePropertyName("ids");
            JsonSerializer.Serialize(writer, fixedDetailRequest.Ids, jsonSerializerOptions);
            writer.WritePropertyName("metrics");
            JsonSerializer.Serialize(writer, fixedDetailRequest.Metrics, jsonSerializerOptions);
            if (fixedDetailRequest.StartDateOption.IsSet)
                writer.WriteString("startDate", fixedDetailRequest.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (fixedDetailRequest.EndDateOption.IsSet)
                writer.WriteString("endDate", fixedDetailRequest.EndDateOption.Value!.Value.ToString(EndDateFormat));

            if (fixedDetailRequest.FrequencyOption.IsSet)
            {
                var frequencyRawValue = FrequencyValueConverter.ToJsonValue(fixedDetailRequest.Frequency!.Value);
                writer.WriteString("frequency", frequencyRawValue);
            }
            if (fixedDetailRequest.IncludeAllOption.IsSet)
                writer.WriteBoolean("includeAll", fixedDetailRequest.IncludeAllOption.Value!.Value);

            if (fixedDetailRequest.PeriodicityOption.IsSet)
            {
                var periodicityRawValue = PeriodicityDetailValueConverter.ToJsonValue(fixedDetailRequest.Periodicity!.Value);
                writer.WriteString("periodicity", periodicityRawValue);
            }
            if (fixedDetailRequest.FiscalPeriodStartOption.IsSet)
                writer.WriteString("fiscalPeriodStart", fixedDetailRequest.FiscalPeriodStart);

            if (fixedDetailRequest.FiscalPeriodEndOption.IsSet)
                writer.WriteString("fiscalPeriodEnd", fixedDetailRequest.FiscalPeriodEnd);

            if (fixedDetailRequest.CurrencyOption.IsSet)
                writer.WriteString("currency", fixedDetailRequest.Currency);
        }
    }
}
