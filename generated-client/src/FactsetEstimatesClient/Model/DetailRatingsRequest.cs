...
namespace FactsetEstimatesClient.Model
{
    ...
    /// </summary>
    public partial class DetailRatingsRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public DetailRatingsRequest(List<string> ids, Option<DateOnly?> startDate = default, Option<DateOnly?> endDate = default, Option<bool?> includeAll = default)
        {
            Ids = ids;
    ...
    /// <summary>
    /// A Json converter for type <see cref="DetailRatingsRequest" />
    /// </summary>
    public class DetailRatingsRequestJsonConverter : JsonConverter<DetailRatingsRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="DetailRatingsRequest" />
        /// </summary>
        ...
        public override DetailRatingsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!ids.IsSet)
                throw new ArgumentException("Property is required for class DetailRatingsRequest.", nameof(ids));

            if (ids.IsSet && ids.Value == null)
                throw new ArgumentNullException(nameof(ids), "Property is not nullable for class DetailRatingsRequest.");

            if (startDate.IsSet && startDate.Value == null)
                throw new ArgumentNullException(nameof(startDate), "Property is not nullable for class DetailRatingsRequest.");

            if (endDate.IsSet && endDate.Value == null)
                throw new ArgumentNullException(nameof(endDate), "Property is not nullable for class DetailRatingsRequest.");

            if (includeAll.IsSet && includeAll.Value == null)
                throw new ArgumentNullException(nameof(includeAll), "Property is not nullable for class DetailRatingsRequest.");

            return new DetailRatingsRequest(ids.Value!, startDate, endDate, includeAll);
        }

        /// <summary>
        /// Serializes a <see cref="DetailRatingsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="detailRatingsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DetailRatingsRequest detailRatingsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, detailRatingsRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DetailRatingsRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="detailRatingsRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DetailRatingsRequest detailRatingsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (detailRatingsRequest.Ids == null)
                throw new ArgumentNullException(nameof(detailRatingsRequest.Ids), "Property is required for class DetailRatingsRequest.");

            writer.WritePropertyName("ids");
            JsonSerializer.Serialize(writer, detailRatingsRequest.Ids, jsonSerializerOptions);
            if (detailRatingsRequest.StartDateOption.IsSet)
                writer.WriteString("startDate", detailRatingsRequest.StartDateOption.Value!.Value.ToString(StartDateFormat));

            if (detailRatingsRequest.EndDateOption.IsSet)
                writer.WriteString("endDate", detailRatingsRequest.EndDateOption.Value!.Value.ToString(EndDateFormat));

            if (detailRatingsRequest.IncludeAllOption.IsSet)
                writer.WriteBoolean("includeAll", detailRatingsRequest.IncludeAllOption.Value!.Value);
        }
    }
}
