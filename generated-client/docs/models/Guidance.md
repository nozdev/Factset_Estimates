# FactsetEstimatesClient.Model.Guidance
...
**ConsensusDate** | **DateOnly** | The perspective date representing the current consensus among analysts as of today, visit [Online Assistant Page | [optional] 
...
**FiscalEndDate** | **DateOnly** | Company&#39;s &#39;fiscal end date&#39; for the estimate record expressed in YYYY-MM-DD format. For more details, visit [Online Assistant Page #16598](https://oa.apps.factset.com/pages/16598) | [optional] 
...
**GuidanceDate** | **DateOnly** | Date guidance was issued expressed in YYYY-MM-DD format. | [optional] 
**InputDateHigh** | **DateOnly** | Represents the date FactSet collected the data in YYYY-MM-DD format for guidance high. | [optional] 
**InputDateLow** | **DateOnly** | Represents the date FactSet collected the data in YYYY-MM-DD format for guidance low. | [optional] 
