# FactsetEstimatesClient.Model.Surprise
...
**Date** | **DateOnly** | Date for data expressed in YYYY-MM-DD format. | [optional] 
...
**SurpriseDate** | **DateOnly** | Date of the reported event expressed in YYYY-MM-DD format. For more details, visit [Online Assistant Page #16601](https://oa.apps.factset.com/pages/16601). | [optional] 
